    ...
    <div class="service_container">
      <div class="container ">
        <div class="heading_container heading_center">
          ...
          <h5>  WORK WITH US THE WAY YOU WANT</h5>
          <p>
            Client trust is our highest priority, and that’s why millions of users choose us. Here are some of the services we offer  that make us a leading online trading service provider.
          </p>
        </div>
        <div class="row">
          <div class="col-md-4 ">
            <div class="box ">
              ...
              <div class="detail-box">
                ...
                <p>
                  Trading currency pairs for everyone, Active way of investing that rewards analytical thinking.Forex currencies are what forex  is all about at it core,use the best it offers to your advantage.
                </p>
                <a href="/signup">
                  REGISTER NOW!
                </a>
          ...
          <div class="col-md-4 ">
            <div class="box ">
              <div class="img-box">
                <img src="../assets/images/broker.png" alt="">
              </div>
              <div class="detail-box">
                <h5>
                  COMMODITIES AND STOCK INDICES
                </h5>
                <p>ApexviewFX makes commodities and stock indices trading easy enjoy the benefits of trading gold, silver, crude oil, and other commodities.Profit from price without having to own any stock.</p>
                </p>  
                <a href="/signup">
                  REGISTER NOW!  </a>
              </div>
