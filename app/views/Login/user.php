...
<head>
  ...
  <link rel="shortcut icon" href="images/w3.png" type="">
  ...
  <link type="text/css" href="assets/toastr/css/toastr.css" rel='stylesheet'>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav  ">
              ...
              <li class="nav-item active">
                <a class="nav-link" href="/Users/contact">contact <span class="sr-only">(current)</span> </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="/Users/login"> <i class="fa fa-user" aria-hidden="true"></i> Login</a>
              </li>
  ...
  <section class="account">
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-lg-10">
					<div class="account-contents" style="background: url('assets/images/stock-g8baef0be3_1920.jpg'); background-size: cover;">
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                <div class="account-content">
                                    <form action="#">
                                        ...
                                        <div class="single-acc-field">
                                            <button type="button" id="login-btn">Login Account</button>
                                        </div>
...
<!-- footer section -->
  ...
  <!-- End Google Map -->
  <script src="/assets/toastr/javascript/toastr.min.js" type="text/javascript"></script>
