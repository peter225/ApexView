    ...
    if (!empty($email) && !empty($password) && !is_numeric($email))
     {
      ...
      $query = "insert into users(user_id, firstName, email, password) values ('user_id','$firstName', '$email', '$password')";
...
<div class="single-acc-field"><label for="name">Name</label> <input id="name" placeholder="Enter Your Name" type="text" name="firstName" /></div>

<div class="single-acc-field"><label for="email">Email</label> <input id="email" placeholder="Enter your Email" type="email" name="email" /></div>

<div class="single-acc-field"><label for="password">Password</label> <input id="password" placeholder="At least 6 Charecter" type="password" name="password" /></div>

<div class="single-acc-field boxes"><input id="checkbox" type="checkbox" /> <label for="checkbox">I&#39;m not a robot</label></div>

<div class="single-acc-field"><button type="submit">Register now</button></div>
<a href="login.html">Already  have an account? Login</a></form>
</div>
</div>
</div>
</div>
